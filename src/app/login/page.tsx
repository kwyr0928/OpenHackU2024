  ...
  return (
    <div className="flex h-screen flex-col justify-center text-center font-mPlus bg-slate-50 max-w-md mx-auto">
      ...
      <div className="items-center">
        ...
        <h2 className="text-darkBlue m-3 pb-7 text-base">初めての方は、こちらからGoogleアカウントを<br />使用してログインしてください</h2>
        <Button
        ...
        >
          ...
          <Image
          src="https://upload.wikimedia.org/wikipedia/commons/c/c1/Google_%22G%22_logo.svg" // ロゴのパス
          alt="google logo"
          width={25}
          height={25}
        />
